...
import { FightStyle, MagicDamageType, PhysicDamageType } from "../../../battle-parser/types/common.js";
import { FightingStyleEffect, ItemEffect, PlayerEffect, SpellEffect, WeapoonSkillEffect } from "../../../battle-parser/types/effect.js";
import { RestorativeSlotItem } from "../../../battle-parser/types/item.js";
import { DeprecatingSpell, SupportiveSpell } from "../../../battle-parser/types/spell.js";
import { MonsterStats } from "../../../battle-parser/types/stats.js"
import { BattleAction } from "../../../command-io/types/index.js";

const playerStatsDemo = {
    vitalRegenRate: {
        magicRegenPerTick: 0,
...
const battleSigrepDemo: BattleSigRep = {
    ...
    monsters: [{
        ...
        effects: [SpellEffect.BluntedAttack, SpellEffect.FreezingLimbs, WeapoonSkillEffect.Stunned]
    },
    {
        name: "Alpha-gravis 011",
        vital: {
...
- ${BattleAction.ITEMS}: player uses an item from their inventory
